...
#else
#define CONFIG_BOOTDELAY	5	/* autoboot after ... seconds	*/
#endif
...
#define	CONFIG_COMMANDS		( CONFIG_CMD_DFL | CFG_CMD_FS | CFG_CMD_DHCP | CFG_CMD_NFS | CFG_CMD_IDE | CFG_CMD_EXT2)
#else
#define	CONFIG_COMMANDS		( CONFIG_CMD_DFL | CFG_CMD_FS | CFG_CMD_DHCP | CFG_CMD_IDE | CFG_CMD_EXT2)
#endif
...
#define CFG_ATA_DATA_OFFSET     0x10                    /* data reg offset    */
#define CFG_ATA_REG_OFFSET      0x10                    /* reg offset */
#define CFG_ATA_ALT_OFFSET      0x48                    /* alternate register offset */
