...
#define	CONFIG_BOOTCOMMAND_FLASH							\
	"setenv bootcmd ;"								\
	"fsload; "									\
	"protect off 10020000 107fffff; "						\
	"setenv bootargs root=/dev/mtdblock2 console=$(console) rootfstype=cramfs; "	\
	"bootm"
...
#define	CONFIG_COMMANDS		( CONFIG_CMD_DFL | CFG_CMD_FS | CFG_CMD_DHCP | CFG_CMD_IDE | CFG_CMD_FAT)

#define	CONFIG_FS		( CFG_FS_CRAMFS | CFG_FS_JFFS2 | CFG_FS_FAT)
...
#define	CONFIG_AUTOBOOT_SELECT_1_TEXT		"boot from disk"
#define	CONFIG_AUTOBOOT_SELECT_1_COMMAND	CONFIG_BOOTCOMMAND_DISK
#define	CONFIG_AUTOBOOT_SELECT_2_TEXT		"boot from flash"
#define	CONFIG_AUTOBOOT_SELECT_2_COMMAND	CONFIG_BOOTCOMMAND_FLASH
#define	CONFIG_AUTOBOOT_SELECT_3_TEXT		"boot from network"
#define	CONFIG_AUTOBOOT_SELECT_3_COMMAND	CONFIG_BOOTCOMMAND_NET
...
#define CFG_ATA_BASE_ADDR       0x02000000   		/* base address */
#define CFG_ATA_IDE0_OFFSET     0x000                   /* default ide0 offste */
#define CFG_ATA_DATA_OFFSET     0                       /* data reg offset    */
#define CFG_ATA_REG_OFFSET      0                       /* reg offset */
#define CFG_ATA_ALT_OFFSET      0x20                    /* alternate register offset */
