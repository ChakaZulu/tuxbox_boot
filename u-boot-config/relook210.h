...
#define CONFIG_RELOOK210	1	/* DGStation relook210 */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
				...
				"stdout=serial\0" \
				"stderr=serial\0" \
				"menu_pal=logo;front_puts \"PAL\";edb add videofmt pal;  echo resetting...;reset\0" \
				"menu_vmode=setenv stdout vga;setenv stderr vga;front_puts \"VMOD\";vmode_select; echo resetting...;reset\0" \
				"menu_mid=setenv stdout vga;setenv stderr vga;front_puts \"MID\";mid_select;  echo resetting...;reset\0" \
				...
				"menu_upgnet=logo;setenv bootargs $bootargs factory_update=1;front_puts \"n up\";boot\0" \
				"serial#=relook210s debugging\0"

#define CONFIG_CFB_CONSOLE
#define CONFIG_VGA_AS_SINGLE_DEVICE
/* Sorry linux, we need space here! */
//#define CONFIG_VIDEO_LOGO
//#define CONFIG_VIDEO_BMP_LOGO
//#define CONFIG_HAS_NO_VIDEO_UCODE
...
#define CFG_ATA_STRIDE      2	/* Width betwix addrs	*/
...
#define CFG_I2C_EEPROM_ADDR_OVERFLOW    1
#define CFG_EEPROM_SIZE			512	/* 4Kbit */
#define CFG_EEPROM_PAGE_WRITE_DELAY_MS	11	/* 10ms. but give more */
#define CFG_EEPROM_PAGE_WRITE_BITS	4	/* 16 bytes in one page */
...
#define CFG_PROMPT		"[u-boot@relook210 boot]$ "	/* Monitor Command Prompt	*/
...
#define CONFIG_DM9000_IRQNUM	26
...
#define ISP116X_HCD_DATA       0xFA000002
#define ISP116X_HCD_ADDR       0xFA000004
...
#define CFG_DEVICE_DEREGISTER           /* CONFIG_USB_KEYBOARD needs device_deregister */
...
#define CFG_SERIALDOWN_HEADER	"relook210"
...
#define CFG_I2C_SLAVE		0xfe	/* we do not use this value... it`s usless */
#define CFG_I2C_NOPROBES	{0x1A}	/* Don't probe these addrs	*/
#endif
