...
#define CONFIG_RELOOK200S	1	/* DGStation relook200s */
...
#define CFG_PROMPT		"[u-boot@relook200s boot]$ "	/* Monitor Command Prompt	*/
...
#define CFG_SERIALDOWN_HEADER	"relook200s"
