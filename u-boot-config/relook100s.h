 ...
 * (easy to change)
 */
//WARNING Define ONLY if your mutant has really 64 megs!!!!
//#define CFG_MUTANT_EXTRA_MEM

#define CONFIG_STBx25xx		1	/* CPU Name		*/
#define CONFIG_RELOOK100S	1	/* DGStation relook100s */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
				...
				"menu_upgnet=setenv bootargs $bootargs factory_update=1;front_puts \"n up\";boot\0" \
				"serial#=relook100s debugging\0"
...
#define CONFIG_BOOTARGS		"console=ttyS2,115200 root=/dev/mtdblock2 panic=1"
...
#define CFG_PROMPT		"[u-boot@relook100s boot]$ "	/* Monitor Command Prompt	*/
...
#define CFG_SERIALDOWN_HEADER	"relook100s"
