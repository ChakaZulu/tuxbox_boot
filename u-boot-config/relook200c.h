...
#define CONFIG_RELOOK200C	1	/* DGStation relook200c */
...
#define CFG_PROMPT		"[u-boot@relook200c boot]$ "	/* Monitor Command Prompt	*/
...
#define CFG_SERIALDOWN_HEADER	"relook200c"
